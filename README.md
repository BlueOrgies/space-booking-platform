...
A booking platform for travel, accomodation and activities in Space. 

## Description
Our space booking platform allows the user to book travel, accomodation and activities in space. 
The user can choose to become an organizer, and create their own listings. These can be edited, cancelled
and reactivated. The users can leave reviews for past trips, and the organizers get an average score based
on these reviews. 
